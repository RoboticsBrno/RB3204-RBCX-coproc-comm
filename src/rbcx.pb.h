...
typedef struct _CoprocReq_SetSmartServo {
    uint32_t servoIndex;
    float position;
} CoprocReq_SetSmartServo;
...
typedef struct _CoprocReq {
    ...
    union {
        ...
        None shutdownPower;
        None versionReq;
        CoprocReq_SetSmartServo setSmartServo;
    } payload;
} CoprocReq;
...
#define MotorConfig_init_default                 {0, 0, 0, 0}
...
#define CoprocReq_SetSmartServo_init_default     {0, 0}
...
#define MotorConfig_init_zero                    {0, 0, 0, 0}
...
#define CoprocReq_SetSmartServo_init_zero        {0, 0}
...
#define CoprocReq_SetSmartServo_servoIndex_tag   1
#define CoprocReq_SetSmartServo_position_tag     2
...
#define MotorConfig_maxSpeed_tag                 4
...
#define CoprocReq_setSmartServo_tag              13
...
X(a, STATIC,   SINGULAR, UINT32,   maxSpeed,          4)
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,setSmartServo,payload.setSmartServo),  13)
...
#define CoprocReq_payload_setSmartServo_MSGTYPE CoprocReq_SetSmartServo
...
#define CoprocReq_SetSmartServo_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   servoIndex,        1) \
X(a, STATIC,   SINGULAR, FLOAT,    position,          2)
#define CoprocReq_SetSmartServo_CALLBACK NULL
#define CoprocReq_SetSmartServo_DEFAULT NULL
...
extern const pb_msgdesc_t CoprocReq_SetSmartServo_msg;
...
#define CoprocReq_SetSmartServo_fields &CoprocReq_SetSmartServo_msg
...
#define MotorConfig_size                         24
#define CoprocReq_size                           35
